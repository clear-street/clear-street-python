...
from .....types.active.v1.instruments import cash_flow_statement_get_instrument_cash_flow_statements_params
from .....types.active.security_id_source import SecurityIDSource
from .....types.active.v1.instruments.cash_flow_statement_get_instrument_cash_flow_statements_response import (
...
class CashFlowStatementsResource(SyncAPIResource):
    ...
    def get_instrument_cash_flow_statements(
        ...
        *,
        ...
        return self._get(
            path_template(
                "/active/v1/instruments/{security_id_source}/{security_id}/cash-flow-statements",
