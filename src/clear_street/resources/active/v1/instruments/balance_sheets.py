...
from .....types.active.v1.instruments import balance_sheet_get_instrument_balance_sheet_statements_params
from .....types.active.security_id_source import SecurityIDSource
from .....types.active.v1.instruments.balance_sheet_get_instrument_balance_sheet_statements_response import (
...
class BalanceSheetsResource(SyncAPIResource):
    ...
    def get_instrument_balance_sheet_statements(
        ...
        *,
        ...
        return self._get(
            path_template(
                "/active/v1/instruments/{security_id_source}/{security_id}/balance-sheets",
