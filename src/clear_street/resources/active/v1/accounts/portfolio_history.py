...
from .....types.active.v1.accounts import portfolio_history_get_portfolio_history_params
from .....types.active.v1.accounts.portfolio_history_get_portfolio_history_response import (
...
class PortfolioHistoryResource(SyncAPIResource):
    ...
    def get_portfolio_history(
        ...
        *,
        ...
        """
        return self._get(
            path_template("/active/v1/accounts/{account_id}/portfolio-history", account_id=account_id),
