...
from .....types.active.v1.omni_ai import entitlement_list_entitlements_params, entitlement_create_entitlements_params
from .....types.active.v1.omni_ai.entitlement_list_entitlements_response import EntitlementListEntitlementsResponse
from .....types.active.v1.omni_ai.entitlement_delete_entitlement_response import EntitlementDeleteEntitlementResponse
from .....types.active.v1.omni_ai.entitlement_create_entitlements_response import EntitlementCreateEntitlementsResponse
...
class EntitlementsResource(SyncAPIResource):
    ...
    def create_entitlements(
        ...
        *,
        ...
        """
        return self._post(
            "/active/v1/omni-ai/entitlements",
    ...
    def delete_entitlement(
        ...
        *,
        ...
        return self._delete(
            path_template("/active/v1/omni-ai/entitlements/{entitlement_id}", entitlement_id=entitlement_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
