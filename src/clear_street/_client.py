...
class ClearStreet(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        base_url_env = os.environ.get("CLEAR_STREET_BASE_URL")
        if is_given(base_url) and base_url is not None:
            ...
            if base_url_env and base_url is not None:
                raise ValueError(
                    "Ambiguous URL; The `CLEAR_STREET_BASE_URL` env var and the `environment` argument are given. If you want to use the environment, you must pass base_url=None",
                )
    ...
    def with_raw_response(self) -> ClearStreetWithRawResponse:
        return ClearStreetWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> ClearStreetWithStreamedResponse:
        return ClearStreetWithStreamedResponse(self)
...
class AsyncClearStreet(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncClearStreet client instance."""
        self.api_key = api_key
    ...
    def with_raw_response(self) -> AsyncClearStreetWithRawResponse:
        return AsyncClearStreetWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncClearStreetWithStreamedResponse:
        return AsyncClearStreetWithStreamedResponse(self)
