...
from clear_street.types.active.v1.accounts import BalanceGetAccountBalancesResponse
...
class TestBalances:
    ...
    def test_method_get_account_balances(self, client: ClearStreet) -> None:
        balance = client.active.v1.accounts.balances.get_account_balances(
            account_id=0,
        )
    ...
    def test_raw_response_get_account_balances(self, client: ClearStreet) -> None:
        response = client.active.v1.accounts.balances.with_raw_response.get_account_balances(
            account_id=0,
        )
    ...
    def test_streaming_response_get_account_balances(self, client: ClearStreet) -> None:
        with client.active.v1.accounts.balances.with_streaming_response.get_account_balances(
            account_id=0,
        ) as response:
...
class TestAsyncBalances:
    ...
    async def test_method_get_account_balances(self, async_client: AsyncClearStreet) -> None:
        balance = await async_client.active.v1.accounts.balances.get_account_balances(
            account_id=0,
        )
        assert_matches_type(BalanceGetAccountBalancesResponse, balance, path=["response"])
    ...
    async def test_raw_response_get_account_balances(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.active.v1.accounts.balances.with_raw_response.get_account_balances(
            account_id=0,
        )
    ...
    async def test_streaming_response_get_account_balances(self, async_client: AsyncClearStreet) -> None:
        async with async_client.active.v1.accounts.balances.with_streaming_response.get_account_balances(
            account_id=0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
