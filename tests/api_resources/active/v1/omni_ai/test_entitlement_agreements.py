...
from clear_street.types.active.v1.omni_ai import EntitlementAgreementListEntitlementAgreementsResponse
...
class TestEntitlementAgreements:
    ...
    def test_method_list_entitlement_agreements(self, client: ClearStreet) -> None:
        entitlement_agreement = client.active.v1.omni_ai.entitlement_agreements.list_entitlement_agreements()
        assert_matches_type(
    ...
    def test_raw_response_list_entitlement_agreements(self, client: ClearStreet) -> None:
        response = client.active.v1.omni_ai.entitlement_agreements.with_raw_response.list_entitlement_agreements()
    ...
    def test_streaming_response_list_entitlement_agreements(self, client: ClearStreet) -> None:
        with (
            client.active.v1.omni_ai.entitlement_agreements.with_streaming_response.list_entitlement_agreements()
        ) as response:
...
class TestAsyncEntitlementAgreements:
    ...
    async def test_method_list_entitlement_agreements(self, async_client: AsyncClearStreet) -> None:
        entitlement_agreement = (
            await async_client.active.v1.omni_ai.entitlement_agreements.list_entitlement_agreements()
        )
        assert_matches_type(
            EntitlementAgreementListEntitlementAgreementsResponse, entitlement_agreement, path=["response"]
        )
    ...
    async def test_raw_response_list_entitlement_agreements(self, async_client: AsyncClearStreet) -> None:
        response = (
            await async_client.active.v1.omni_ai.entitlement_agreements.with_raw_response.list_entitlement_agreements()
        )
    ...
    async def test_streaming_response_list_entitlement_agreements(self, async_client: AsyncClearStreet) -> None:
        async with (
            async_client.active.v1.omni_ai.entitlement_agreements.with_streaming_response.list_entitlement_agreements()
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
