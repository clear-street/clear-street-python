...
class TestResponses:
    ...
    def test_method_cancel_response(self, client: ClearStreet) -> None:
        response = client.active.v1.omni_ai.responses.cancel_response(
    ...
    def test_raw_response_cancel_response(self, client: ClearStreet) -> None:
        http_response = client.active.v1.omni_ai.responses.with_raw_response.cancel_response(
            response_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id=0,
        )
    ...
    def test_streaming_response_cancel_response(self, client: ClearStreet) -> None:
        with client.active.v1.omni_ai.responses.with_streaming_response.cancel_response(
            response_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id=0,
        ) as http_response:
    ...
    def test_path_params_cancel_response(self, client: ClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `response_id` but received ''"):
            client.active.v1.omni_ai.responses.with_raw_response.cancel_response(
                response_id="",
                account_id=0,
            )
    ...
    def test_method_get_response(self, client: ClearStreet) -> None:
        response = client.active.v1.omni_ai.responses.get_response(
            response_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id=0,
        )
    ...
    def test_raw_response_get_response(self, client: ClearStreet) -> None:
        http_response = client.active.v1.omni_ai.responses.with_raw_response.get_response(
            response_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id=0,
        )
    ...
    def test_streaming_response_get_response(self, client: ClearStreet) -> None:
        with client.active.v1.omni_ai.responses.with_streaming_response.get_response(
            response_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id=0,
        ) as http_response:
            assert not http_response.is_closed
    ...
    def test_path_params_get_response(self, client: ClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `response_id` but received ''"):
            client.active.v1.omni_ai.responses.with_raw_response.get_response(
                response_id="",
                account_id=0,
            )
...
class TestAsyncResponses:
    ...
    async def test_method_cancel_response(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.active.v1.omni_ai.responses.cancel_response(
            response_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id=0,
        )
        assert_matches_type(ResponseCancelResponseResponse, response, path=["response"])
    ...
    async def test_raw_response_cancel_response(self, async_client: AsyncClearStreet) -> None:
        http_response = await async_client.active.v1.omni_ai.responses.with_raw_response.cancel_response(
            response_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id=0,
        )
    ...
    async def test_streaming_response_cancel_response(self, async_client: AsyncClearStreet) -> None:
        async with async_client.active.v1.omni_ai.responses.with_streaming_response.cancel_response(
            response_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id=0,
        ) as http_response:
            assert not http_response.is_closed
    ...
    async def test_path_params_cancel_response(self, async_client: AsyncClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `response_id` but received ''"):
            await async_client.active.v1.omni_ai.responses.with_raw_response.cancel_response(
                response_id="",
                account_id=0,
            )
    ...
    async def test_method_get_response(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.active.v1.omni_ai.responses.get_response(
            response_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id=0,
        )
        assert_matches_type(ResponseGetResponseResponse, response, path=["response"])
    ...
    async def test_raw_response_get_response(self, async_client: AsyncClearStreet) -> None:
        http_response = await async_client.active.v1.omni_ai.responses.with_raw_response.get_response(
            response_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id=0,
        )
    ...
    async def test_streaming_response_get_response(self, async_client: AsyncClearStreet) -> None:
        async with async_client.active.v1.omni_ai.responses.with_streaming_response.get_response(
            response_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id=0,
        ) as http_response:
            assert not http_response.is_closed
    ...
    async def test_path_params_get_response(self, async_client: AsyncClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `response_id` but received ''"):
            await async_client.active.v1.omni_ai.responses.with_raw_response.get_response(
                response_id="",
                account_id=0,
            )
