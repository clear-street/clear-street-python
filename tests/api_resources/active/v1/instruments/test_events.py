...
class TestEvents:
    ...
    def test_method_get_all_instrument_events(self, client: ClearStreet) -> None:
        event = client.active.v1.instruments.events.get_all_instrument_events()
    ...
    def test_raw_response_get_all_instrument_events(self, client: ClearStreet) -> None:
        response = client.active.v1.instruments.events.with_raw_response.get_all_instrument_events()
    ...
    def test_streaming_response_get_all_instrument_events(self, client: ClearStreet) -> None:
        with client.active.v1.instruments.events.with_streaming_response.get_all_instrument_events() as response:
    ...
    def test_method_get_instrument_events(self, client: ClearStreet) -> None:
        event = client.active.v1.instruments.events.get_instrument_events(
    ...
    def test_raw_response_get_instrument_events(self, client: ClearStreet) -> None:
        response = client.active.v1.instruments.events.with_raw_response.get_instrument_events(
            security_id="security_id",
            security_id_source="CMS",
        )
    ...
    def test_streaming_response_get_instrument_events(self, client: ClearStreet) -> None:
        with client.active.v1.instruments.events.with_streaming_response.get_instrument_events(
            security_id="security_id",
            security_id_source="CMS",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_get_instrument_events(self, client: ClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `security_id` but received ''"):
            client.active.v1.instruments.events.with_raw_response.get_instrument_events(
                security_id="",
                security_id_source="CMS",
            )
...
class TestAsyncEvents:
    ...
    async def test_method_get_all_instrument_events(self, async_client: AsyncClearStreet) -> None:
        event = await async_client.active.v1.instruments.events.get_all_instrument_events()
        assert_matches_type(EventGetAllInstrumentEventsResponse, event, path=["response"])
    ...
    async def test_raw_response_get_all_instrument_events(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.active.v1.instruments.events.with_raw_response.get_all_instrument_events()
    ...
    async def test_streaming_response_get_all_instrument_events(self, async_client: AsyncClearStreet) -> None:
        async with (
            async_client.active.v1.instruments.events.with_streaming_response.get_all_instrument_events()
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_get_instrument_events(self, async_client: AsyncClearStreet) -> None:
        event = await async_client.active.v1.instruments.events.get_instrument_events(
            security_id="security_id",
            security_id_source="CMS",
        )
        assert_matches_type(EventGetInstrumentEventsResponse, event, path=["response"])
    ...
    async def test_raw_response_get_instrument_events(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.active.v1.instruments.events.with_raw_response.get_instrument_events(
            security_id="security_id",
            security_id_source="CMS",
        )
    ...
    async def test_streaming_response_get_instrument_events(self, async_client: AsyncClearStreet) -> None:
        async with async_client.active.v1.instruments.events.with_streaming_response.get_instrument_events(
            security_id="security_id",
            security_id_source="CMS",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get_instrument_events(self, async_client: AsyncClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `security_id` but received ''"):
            await async_client.active.v1.instruments.events.with_raw_response.get_instrument_events(
                security_id="",
                security_id_source="CMS",
            )
