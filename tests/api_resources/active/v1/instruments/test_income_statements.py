...
class TestIncomeStatements:
    ...
    def test_method_get_instrument_income_statements(self, client: ClearStreet) -> None:
        income_statement = client.active.v1.instruments.income_statements.get_instrument_income_statements(
            security_id="security_id",
            security_id_source="CMS",
        )
        assert_matches_type(IncomeStatementGetInstrumentIncomeStatementsResponse, income_statement, path=["response"])
    ...
    def test_raw_response_get_instrument_income_statements(self, client: ClearStreet) -> None:
        response = client.active.v1.instruments.income_statements.with_raw_response.get_instrument_income_statements(
            security_id="security_id",
            security_id_source="CMS",
        )
        ...
        income_statement = response.parse()
        assert_matches_type(IncomeStatementGetInstrumentIncomeStatementsResponse, income_statement, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_get_instrument_income_statements(self, client: ClearStreet) -> None:
        with client.active.v1.instruments.income_statements.with_streaming_response.get_instrument_income_statements(
            security_id="security_id",
            security_id_source="CMS",
        ) as response:
            ...
            income_statement = response.parse()
            assert_matches_type(
                IncomeStatementGetInstrumentIncomeStatementsResponse, income_statement, path=["response"]
            )
    ...
    def test_path_params_get_instrument_income_statements(self, client: ClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `security_id` but received ''"):
            client.active.v1.instruments.income_statements.with_raw_response.get_instrument_income_statements(
                security_id="",
                security_id_source="CMS",
            )
...
class TestAsyncIncomeStatements:
    ...
    async def test_method_get_instrument_income_statements(self, async_client: AsyncClearStreet) -> None:
        income_statement = await async_client.active.v1.instruments.income_statements.get_instrument_income_statements(
            security_id="security_id",
            security_id_source="CMS",
        )
        assert_matches_type(IncomeStatementGetInstrumentIncomeStatementsResponse, income_statement, path=["response"])
    ...
    async def test_raw_response_get_instrument_income_statements(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.active.v1.instruments.income_statements.with_raw_response.get_instrument_income_statements(
            security_id="security_id",
            security_id_source="CMS",
        )
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        income_statement = await response.parse()
        assert_matches_type(IncomeStatementGetInstrumentIncomeStatementsResponse, income_statement, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_get_instrument_income_statements(self, async_client: AsyncClearStreet) -> None:
        async with async_client.active.v1.instruments.income_statements.with_streaming_response.get_instrument_income_statements(
            security_id="security_id",
            security_id_source="CMS",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get_instrument_income_statements(self, async_client: AsyncClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `security_id` but received ''"):
            await (
                async_client.active.v1.instruments.income_statements.with_raw_response.get_instrument_income_statements(
                    security_id="",
                    security_id_source="CMS",
                )
            )
