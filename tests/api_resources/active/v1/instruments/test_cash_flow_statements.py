...
class TestCashFlowStatements:
    ...
    def test_method_get_instrument_cash_flow_statements(self, client: ClearStreet) -> None:
        cash_flow_statement = client.active.v1.instruments.cash_flow_statements.get_instrument_cash_flow_statements(
    ...
    def test_raw_response_get_instrument_cash_flow_statements(self, client: ClearStreet) -> None:
        response = (
            client.active.v1.instruments.cash_flow_statements.with_raw_response.get_instrument_cash_flow_statements(
                security_id="security_id",
                security_id_source="CMS",
            )
        )
    ...
    def test_streaming_response_get_instrument_cash_flow_statements(self, client: ClearStreet) -> None:
        with client.active.v1.instruments.cash_flow_statements.with_streaming_response.get_instrument_cash_flow_statements(
            security_id="security_id",
            security_id_source="CMS",
        ) as response:
...
class TestAsyncCashFlowStatements:
    ...
    async def test_method_get_instrument_cash_flow_statements(self, async_client: AsyncClearStreet) -> None:
        cash_flow_statement = (
            await async_client.active.v1.instruments.cash_flow_statements.get_instrument_cash_flow_statements(
                security_id="security_id",
                security_id_source="CMS",
            )
        )
    ...
    async def test_raw_response_get_instrument_cash_flow_statements(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.active.v1.instruments.cash_flow_statements.with_raw_response.get_instrument_cash_flow_statements(
            security_id="security_id",
            security_id_source="CMS",
        )
    ...
    async def test_streaming_response_get_instrument_cash_flow_statements(self, async_client: AsyncClearStreet) -> None:
        async with async_client.active.v1.instruments.cash_flow_statements.with_streaming_response.get_instrument_cash_flow_statements(
            security_id="security_id",
            security_id_source="CMS",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get_instrument_cash_flow_statements(self, async_client: AsyncClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `security_id` but received ''"):
            await async_client.active.v1.instruments.cash_flow_statements.with_raw_response.get_instrument_cash_flow_statements(
                security_id="",
                security_id_source="CMS",
            )
