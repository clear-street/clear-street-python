...
class TestMergersAcquisitions:
    ...
    def test_streaming_response_get_mergers_and_acquisitions_calendar(self, client: ClearStreet) -> None:
        with client.active.v1.calendars.mergers_acquisitions.with_streaming_response.get_mergers_and_acquisitions_calendar(
            from_date="from_date",
            to_date="to_date",
        ) as response:
...
class TestAsyncMergersAcquisitions:
    ...
    async def test_streaming_response_get_mergers_and_acquisitions_calendar(
        ...
        async with async_client.active.v1.calendars.mergers_acquisitions.with_streaming_response.get_mergers_and_acquisitions_calendar(
            from_date="from_date",
            to_date="to_date",
        ) as response:
            assert not response.is_closed
