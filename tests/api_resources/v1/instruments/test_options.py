...
class TestOptions:
    ...
    def test_method_get_option_contracts(self, client: ClearStreet) -> None:
        option = client.v1.instruments.options.get_option_contracts()
        assert_matches_type(OptionGetOptionContractsResponse, option, path=["response"])
    ...
    def test_raw_response_get_option_contracts(self, client: ClearStreet) -> None:
        response = client.v1.instruments.options.with_raw_response.get_option_contracts()
    ...
    def test_streaming_response_get_option_contracts(self, client: ClearStreet) -> None:
        with client.v1.instruments.options.with_streaming_response.get_option_contracts() as response:
...
class TestAsyncOptions:
    ...
    async def test_method_get_option_contracts(self, async_client: AsyncClearStreet) -> None:
        option = await async_client.v1.instruments.options.get_option_contracts()
        assert_matches_type(OptionGetOptionContractsResponse, option, path=["response"])
    ...
    async def test_raw_response_get_option_contracts(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.v1.instruments.options.with_raw_response.get_option_contracts()
    ...
    async def test_streaming_response_get_option_contracts(self, async_client: AsyncClearStreet) -> None:
        async with async_client.v1.instruments.options.with_streaming_response.get_option_contracts() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
