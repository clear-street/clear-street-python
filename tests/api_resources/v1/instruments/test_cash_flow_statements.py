...
class TestCashFlowStatements:
    ...
    def test_method_get_instrument_cash_flow_statements(self, client: ClearStreet) -> None:
        cash_flow_statement = client.v1.instruments.cash_flow_statements.get_instrument_cash_flow_statements(
            instrument_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(
            CashFlowStatementGetInstrumentCashFlowStatementsResponse, cash_flow_statement, path=["response"]
        )
    ...
    def test_raw_response_get_instrument_cash_flow_statements(self, client: ClearStreet) -> None:
        response = client.v1.instruments.cash_flow_statements.with_raw_response.get_instrument_cash_flow_statements(
            instrument_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        cash_flow_statement = response.parse()
        assert_matches_type(
            CashFlowStatementGetInstrumentCashFlowStatementsResponse, cash_flow_statement, path=["response"]
        )
    ...
    def test_streaming_response_get_instrument_cash_flow_statements(self, client: ClearStreet) -> None:
        with client.v1.instruments.cash_flow_statements.with_streaming_response.get_instrument_cash_flow_statements(
            instrument_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_get_instrument_cash_flow_statements(self, client: ClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `instrument_id` but received ''"):
            client.v1.instruments.cash_flow_statements.with_raw_response.get_instrument_cash_flow_statements(
                instrument_id="",
            )
...
class TestAsyncCashFlowStatements:
    ...
    async def test_method_get_instrument_cash_flow_statements(self, async_client: AsyncClearStreet) -> None:
        cash_flow_statement = (
            await async_client.v1.instruments.cash_flow_statements.get_instrument_cash_flow_statements(
                instrument_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            )
        )
        assert_matches_type(
    ...
    async def test_raw_response_get_instrument_cash_flow_statements(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.v1.instruments.cash_flow_statements.with_raw_response.get_instrument_cash_flow_statements(
            instrument_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        cash_flow_statement = await response.parse()
        assert_matches_type(
            CashFlowStatementGetInstrumentCashFlowStatementsResponse, cash_flow_statement, path=["response"]
        )
    ...
    async def test_streaming_response_get_instrument_cash_flow_statements(self, async_client: AsyncClearStreet) -> None:
        async with async_client.v1.instruments.cash_flow_statements.with_streaming_response.get_instrument_cash_flow_statements(
            instrument_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get_instrument_cash_flow_statements(self, async_client: AsyncClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `instrument_id` but received ''"):
            await (
                async_client.v1.instruments.cash_flow_statements.with_raw_response.get_instrument_cash_flow_statements(
                    instrument_id="",
                )
            )
