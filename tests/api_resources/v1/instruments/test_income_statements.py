...
class TestIncomeStatements:
    ...
    def test_method_get_instrument_income_statements(self, client: ClearStreet) -> None:
        income_statement = client.v1.instruments.income_statements.get_instrument_income_statements(
    ...
    def test_raw_response_get_instrument_income_statements(self, client: ClearStreet) -> None:
        response = client.v1.instruments.income_statements.with_raw_response.get_instrument_income_statements(
            instrument_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_get_instrument_income_statements(self, client: ClearStreet) -> None:
        with client.v1.instruments.income_statements.with_streaming_response.get_instrument_income_statements(
            instrument_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_get_instrument_income_statements(self, client: ClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `instrument_id` but received ''"):
            client.v1.instruments.income_statements.with_raw_response.get_instrument_income_statements(
                instrument_id="",
            )
...
class TestAsyncIncomeStatements:
    ...
    async def test_method_get_instrument_income_statements(self, async_client: AsyncClearStreet) -> None:
        income_statement = await async_client.v1.instruments.income_statements.get_instrument_income_statements(
            instrument_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(IncomeStatementGetInstrumentIncomeStatementsResponse, income_statement, path=["response"])
    ...
    async def test_raw_response_get_instrument_income_statements(self, async_client: AsyncClearStreet) -> None:
        response = (
            await async_client.v1.instruments.income_statements.with_raw_response.get_instrument_income_statements(
                instrument_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            )
        )
    ...
    async def test_streaming_response_get_instrument_income_statements(self, async_client: AsyncClearStreet) -> None:
        async with (
            async_client.v1.instruments.income_statements.with_streaming_response.get_instrument_income_statements(
                instrument_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            )
        ) as response:
            assert not response.is_closed
