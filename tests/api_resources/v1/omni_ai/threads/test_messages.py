...
class TestMessages:
    ...
    def test_method_create_message(self, client: ClearStreet) -> None:
        message = client.v1.omni_ai.threads.messages.create_message(
    ...
    def test_raw_response_create_message(self, client: ClearStreet) -> None:
        response = client.v1.omni_ai.threads.messages.with_raw_response.create_message(
            thread_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id=19816,
            text="Compare that to AMD.",
        )
    ...
    def test_streaming_response_create_message(self, client: ClearStreet) -> None:
        with client.v1.omni_ai.threads.messages.with_streaming_response.create_message(
            thread_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id=19816,
            text="Compare that to AMD.",
        ) as response:
    ...
    def test_path_params_create_message(self, client: ClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `thread_id` but received ''"):
            client.v1.omni_ai.threads.messages.with_raw_response.create_message(
                thread_id="",
                account_id=19816,
                text="Compare that to AMD.",
            )
...
class TestAsyncMessages:
    ...
    async def test_method_create_message(self, async_client: AsyncClearStreet) -> None:
        message = await async_client.v1.omni_ai.threads.messages.create_message(
            thread_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id=19816,
            text="Compare that to AMD.",
        )
    ...
    async def test_raw_response_create_message(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.v1.omni_ai.threads.messages.with_raw_response.create_message(
            thread_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id=19816,
            text="Compare that to AMD.",
        )
    ...
    async def test_streaming_response_create_message(self, async_client: AsyncClearStreet) -> None:
        async with async_client.v1.omni_ai.threads.messages.with_streaming_response.create_message(
            thread_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            account_id=19816,
            text="Compare that to AMD.",
        ) as response:
    ...
    async def test_path_params_create_message(self, async_client: AsyncClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `thread_id` but received ''"):
            await async_client.v1.omni_ai.threads.messages.with_raw_response.create_message(
                thread_id="",
                account_id=19816,
                text="Compare that to AMD.",
            )
