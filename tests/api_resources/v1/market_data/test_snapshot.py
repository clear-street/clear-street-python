...
from clear_street.types.v1.market_data import SnapshotGetSnapshotsResponse
...
class TestSnapshot:
    ...
    def test_method_get_snapshots(self, client: ClearStreet) -> None:
        snapshot = client.v1.market_data.snapshot.get_snapshots()
    ...
    def test_raw_response_get_snapshots(self, client: ClearStreet) -> None:
        response = client.v1.market_data.snapshot.with_raw_response.get_snapshots()
    ...
    def test_streaming_response_get_snapshots(self, client: ClearStreet) -> None:
        with client.v1.market_data.snapshot.with_streaming_response.get_snapshots() as response:
...
class TestAsyncSnapshot:
    ...
    async def test_method_get_snapshots(self, async_client: AsyncClearStreet) -> None:
        snapshot = await async_client.v1.market_data.snapshot.get_snapshots()
        assert_matches_type(SnapshotGetSnapshotsResponse, snapshot, path=["response"])
    ...
    async def test_raw_response_get_snapshots(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.v1.market_data.snapshot.with_raw_response.get_snapshots()
    ...
    async def test_streaming_response_get_snapshots(self, async_client: AsyncClearStreet) -> None:
        async with async_client.v1.market_data.snapshot.with_streaming_response.get_snapshots() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
