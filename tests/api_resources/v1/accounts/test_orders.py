...
class TestOrders:
    ...
    def test_method_cancel_all_open_orders(self, client: ClearStreet) -> None:
        order = client.v1.accounts.orders.cancel_all_open_orders(
            account_id=0,
        )
    ...
    def test_raw_response_cancel_all_open_orders(self, client: ClearStreet) -> None:
        response = client.v1.accounts.orders.with_raw_response.cancel_all_open_orders(
            account_id=0,
        )
    ...
    def test_streaming_response_cancel_all_open_orders(self, client: ClearStreet) -> None:
        with client.v1.accounts.orders.with_streaming_response.cancel_all_open_orders(
            account_id=0,
        ) as response:
    ...
    def test_method_cancel_open_order(self, client: ClearStreet) -> None:
        order = client.v1.accounts.orders.cancel_open_order(
            order_id="order_id",
            account_id=0,
        )
    ...
    def test_raw_response_cancel_open_order(self, client: ClearStreet) -> None:
        response = client.v1.accounts.orders.with_raw_response.cancel_open_order(
            order_id="order_id",
            account_id=0,
        )
    ...
    def test_streaming_response_cancel_open_order(self, client: ClearStreet) -> None:
        with client.v1.accounts.orders.with_streaming_response.cancel_open_order(
            order_id="order_id",
            account_id=0,
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_cancel_open_order(self, client: ClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `order_id` but received ''"):
            client.v1.accounts.orders.with_raw_response.cancel_open_order(
                order_id="",
                account_id=0,
            )
    ...
    def test_method_get_order_by_id(self, client: ClearStreet) -> None:
        order = client.v1.accounts.orders.get_order_by_id(
            order_id="order_id",
            account_id=0,
        )
    ...
    def test_raw_response_get_order_by_id(self, client: ClearStreet) -> None:
        response = client.v1.accounts.orders.with_raw_response.get_order_by_id(
            order_id="order_id",
            account_id=0,
        )
    ...
    def test_streaming_response_get_order_by_id(self, client: ClearStreet) -> None:
        with client.v1.accounts.orders.with_streaming_response.get_order_by_id(
            order_id="order_id",
            account_id=0,
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_get_order_by_id(self, client: ClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `order_id` but received ''"):
            client.v1.accounts.orders.with_raw_response.get_order_by_id(
                order_id="",
                account_id=0,
            )
    ...
    def test_method_get_orders(self, client: ClearStreet) -> None:
        order = client.v1.accounts.orders.get_orders(
            account_id=0,
        )
    ...
    def test_raw_response_get_orders(self, client: ClearStreet) -> None:
        response = client.v1.accounts.orders.with_raw_response.get_orders(
            account_id=0,
        )
    ...
    def test_streaming_response_get_orders(self, client: ClearStreet) -> None:
        with client.v1.accounts.orders.with_streaming_response.get_orders(
            account_id=0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_replace_order(self, client: ClearStreet) -> None:
        order = client.v1.accounts.orders.replace_order(
            order_id="order_id",
            account_id=0,
        )
    ...
    def test_raw_response_replace_order(self, client: ClearStreet) -> None:
        response = client.v1.accounts.orders.with_raw_response.replace_order(
            order_id="order_id",
            account_id=0,
        )
    ...
    def test_streaming_response_replace_order(self, client: ClearStreet) -> None:
        with client.v1.accounts.orders.with_streaming_response.replace_order(
            order_id="order_id",
            account_id=0,
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_replace_order(self, client: ClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `order_id` but received ''"):
            client.v1.accounts.orders.with_raw_response.replace_order(
                order_id="",
                account_id=0,
            )
    ...
    def test_method_submit_orders(self, client: ClearStreet) -> None:
        order = client.v1.accounts.orders.submit_orders(
            account_id=0,
            orders=[
                {
                    "legs": [
    ...
    def test_raw_response_submit_orders(self, client: ClearStreet) -> None:
        response = client.v1.accounts.orders.with_raw_response.submit_orders(
            account_id=0,
            orders=[
                {
                    "legs": [
    ...
    def test_streaming_response_submit_orders(self, client: ClearStreet) -> None:
        with client.v1.accounts.orders.with_streaming_response.submit_orders(
            account_id=0,
            orders=[
                {
                    "legs": [
...
class TestAsyncOrders:
    ...
    async def test_method_cancel_all_open_orders(self, async_client: AsyncClearStreet) -> None:
        order = await async_client.v1.accounts.orders.cancel_all_open_orders(
            account_id=0,
        )
        assert_matches_type(OrderCancelAllOpenOrdersResponse, order, path=["response"])
    ...
    async def test_raw_response_cancel_all_open_orders(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.v1.accounts.orders.with_raw_response.cancel_all_open_orders(
            account_id=0,
        )
    ...
    async def test_streaming_response_cancel_all_open_orders(self, async_client: AsyncClearStreet) -> None:
        async with async_client.v1.accounts.orders.with_streaming_response.cancel_all_open_orders(
            account_id=0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_cancel_open_order(self, async_client: AsyncClearStreet) -> None:
        order = await async_client.v1.accounts.orders.cancel_open_order(
            order_id="order_id",
            account_id=0,
        )
        assert_matches_type(OrderCancelOpenOrderResponse, order, path=["response"])
    ...
    async def test_raw_response_cancel_open_order(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.v1.accounts.orders.with_raw_response.cancel_open_order(
            order_id="order_id",
            account_id=0,
        )
    ...
    async def test_streaming_response_cancel_open_order(self, async_client: AsyncClearStreet) -> None:
        async with async_client.v1.accounts.orders.with_streaming_response.cancel_open_order(
            order_id="order_id",
            account_id=0,
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_cancel_open_order(self, async_client: AsyncClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `order_id` but received ''"):
            await async_client.v1.accounts.orders.with_raw_response.cancel_open_order(
                order_id="",
                account_id=0,
            )
    ...
    async def test_method_get_order_by_id(self, async_client: AsyncClearStreet) -> None:
        order = await async_client.v1.accounts.orders.get_order_by_id(
            order_id="order_id",
            account_id=0,
        )
        assert_matches_type(OrderGetOrderByIDResponse, order, path=["response"])
    ...
    async def test_raw_response_get_order_by_id(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.v1.accounts.orders.with_raw_response.get_order_by_id(
            order_id="order_id",
            account_id=0,
        )
    ...
    async def test_streaming_response_get_order_by_id(self, async_client: AsyncClearStreet) -> None:
        async with async_client.v1.accounts.orders.with_streaming_response.get_order_by_id(
            order_id="order_id",
            account_id=0,
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get_order_by_id(self, async_client: AsyncClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `order_id` but received ''"):
            await async_client.v1.accounts.orders.with_raw_response.get_order_by_id(
                order_id="",
                account_id=0,
            )
    ...
    async def test_method_get_orders(self, async_client: AsyncClearStreet) -> None:
        order = await async_client.v1.accounts.orders.get_orders(
            account_id=0,
        )
        assert_matches_type(OrderGetOrdersResponse, order, path=["response"])
    ...
    async def test_raw_response_get_orders(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.v1.accounts.orders.with_raw_response.get_orders(
            account_id=0,
        )
    ...
    async def test_streaming_response_get_orders(self, async_client: AsyncClearStreet) -> None:
        async with async_client.v1.accounts.orders.with_streaming_response.get_orders(
            account_id=0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_replace_order(self, async_client: AsyncClearStreet) -> None:
        order = await async_client.v1.accounts.orders.replace_order(
            order_id="order_id",
            account_id=0,
        )
        assert_matches_type(OrderReplaceOrderResponse, order, path=["response"])
    ...
    async def test_raw_response_replace_order(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.v1.accounts.orders.with_raw_response.replace_order(
            order_id="order_id",
            account_id=0,
        )
    ...
    async def test_streaming_response_replace_order(self, async_client: AsyncClearStreet) -> None:
        async with async_client.v1.accounts.orders.with_streaming_response.replace_order(
            order_id="order_id",
            account_id=0,
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_replace_order(self, async_client: AsyncClearStreet) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `order_id` but received ''"):
            await async_client.v1.accounts.orders.with_raw_response.replace_order(
                order_id="",
                account_id=0,
            )
    ...
    async def test_method_submit_orders(self, async_client: AsyncClearStreet) -> None:
        order = await async_client.v1.accounts.orders.submit_orders(
            account_id=0,
            orders=[
                {
                    "legs": [
    ...
    async def test_raw_response_submit_orders(self, async_client: AsyncClearStreet) -> None:
        response = await async_client.v1.accounts.orders.with_raw_response.submit_orders(
            account_id=0,
            orders=[
                {
                    "legs": [
    ...
    async def test_streaming_response_submit_orders(self, async_client: AsyncClearStreet) -> None:
        async with async_client.v1.accounts.orders.with_streaming_response.submit_orders(
            account_id=0,
            orders=[
                {
                    "legs": [
