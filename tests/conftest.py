...
from clearstreet import ClearStreet, AsyncClearStreet, DefaultAioHttpClient
from clearstreet._utils import is_dict
...
logging.getLogger("clearstreet").setLevel(logging.DEBUG)
